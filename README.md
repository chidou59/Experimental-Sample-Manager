...
**实验试样记录管理中心** 是一个基于 Python 和 PySide6 开发的桌面应用程序，专为各行各业需要试验制样的科研人员设计。
在传统的实验记录中，数据往往分散在 Excel 表格、手写实验记录本和各种文件夹中，难以追溯和整理。

本软件旨在提供一个**结构化、可视化、交互式**的平台，帮助研究人员高效记录试样的全生命周期数据——从制样、养护、质量监测到最终的力学测试。
<div align="center">
  <img src="fig/fig1.png" width="800" />
  <br> <p>图 1：试样记录管理中心主界面</p>
</div>
## ✨ 核心功能 (Key Features)
